...
ape::write.tree(
  ape::drop.tip(tree, tip = missing_seqs), file = "Test_Set/epa_ng/AFTOL_test/SSU/AFTOL_tree_SSU_epa_ng.tre")
...
SSU_Alignment %>%
  filter(str_detect(Header, pattern = "TBAS") | 
         str_detect(Header, pattern = "Phylogenomic") |
         str_detect(Header, pattern = "Agarico")) %>%
  writeFasta("Test_Set/epa_ng/AFTOL_test/SSU/ssu_query.fasta")


# create query
SSU_Alignment %>%
  filter(str_detect(Header, pattern = "TBAS", negate = TRUE) & 
         str_detect(Header, pattern = "Phylogenomic", negate = TRUE) &
         str_detect(Header, pattern = "Agarico", negate = TRUE)) %>%
